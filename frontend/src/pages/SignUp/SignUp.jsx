  ...
  return (
   <>
    ...
    <div className='flex items-center justify-center mt-28 rounded-2xl  '>
      <div className='w-96 border rounded-xl bg-yellow-100 pb-6 mx-5 '>
      <h4 className='text-2xl mb-7 bg-yellow-400 px-7 h-18 text-center pt-5 font-medium rounded-t-xl '>SignUp</h4>
         ...
         <button 
            type='submit'
            className='w-full  text-sm bg-fuchsia-600 text-white p-2 rounded my-1 hover:bg-fuchsia-800 duration-200 border  cursor-pointer '
            >Create Account
            </button>
         </div>
